...
function Sobre() {
  return (
    <div>
      <div className='top-8 relative'><h1 className='text-3xl text-rose-600'> Sobre o AlimentaA! </h1></div>

      <div className='flex flex-col flex-center mx-[20%] my-10 m-auto min-h-[62vh] text-justify top-4 relative gap-4'>
      ...
      <div className='my-8 mt-16'>
        <p className='text-1xl text-green-600'>Obrigado por fazer parte da nossa comunidade. &#128154;</p>

        <p className='text-1xl text-green-600'>Atenciosamente,</p>

        <p className='text-1xl text-rose-700'>AlimentaA! - Raízes Sustentáveis</p>
      </div>
    </div>
  )
}
