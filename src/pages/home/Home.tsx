  ...
  return (
    <>
      ...
      <div className='flex justify-center border-b-4 border-neutral-200 top-8 relative pb-5'>
        <Carousel transition={{ duration: 2 }} className="rounded-xl w-1/2 h-1/2" autoplay={true}>
          <img
            src={foto1}
            alt="image 1"
